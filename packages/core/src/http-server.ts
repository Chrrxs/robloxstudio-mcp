...
export const TOOL_HANDLERS: Record<string, ToolHandler> = {
  ...
  debug_control: (tools, body) => tools.debugControl(body.action, body.params, body.target, body.instance_id),
  debug_inspect: (tools, body) => tools.debugInspect(body.action, body.params, body.target, body.instance_id),
