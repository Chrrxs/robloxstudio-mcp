...
- **Status:** fixed in this PR — test `tests/field-2026-09-15/01-capture-play-blank.mjs` (+ jest `packages/core/src/__tests__/field-01-capture-markers.test.ts`), evidence `tests/field-2026-09-15/evidence/01-capture-play-blank.md`.
